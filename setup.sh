...
#   nft:       $nft_path
#
# This file includes all common paths for cross-distro compatibility.
# Remove this file to revoke: sudo rm $SUDOERS_DEST

# === $sudo_group group ===

# Arch Linux / Manjaro paths (/usr/bin)
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/iptables
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/iptables-legacy
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/iptables-nft
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/ip6tables
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/ip6tables-legacy
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/ip6tables-nft
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/bin/nft

# Debian / Ubuntu / Fedora / RHEL paths (/usr/sbin)
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/iptables
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/iptables-legacy
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/iptables-nft
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables-legacy
%${sudo_group} ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables-nft
...
%sudo ALL=(ALL) NOPASSWD: /usr/bin/iptables-legacy
%sudo ALL=(ALL) NOPASSWD: /usr/bin/iptables-nft
%sudo ALL=(ALL) NOPASSWD: /usr/bin/ip6tables
%sudo ALL=(ALL) NOPASSWD: /usr/bin/ip6tables-legacy
%sudo ALL=(ALL) NOPASSWD: /usr/bin/ip6tables-nft
%sudo ALL=(ALL) NOPASSWD: /usr/bin/nft
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/iptables
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/iptables-legacy
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/iptables-nft
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables-legacy
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/ip6tables-nft
%sudo ALL=(ALL) NOPASSWD: /usr/sbin/nft
EOF
    fi
